...
# A wget progroam is a program that gets information from the "w"eb
# 
...
# w = writr
# r = read
# t = text = > automatically apply encoding 
# b = binary / bytes = > dont apply the encoding 
# x = write, but if the firle already exists throw error
